create table lancamento (
    codigo bigserial(20) primary key auto_increment,
    ...
    codigo_categoria bigserial(20) not null,
    codigo_pessoa bigserial(20) not null,
    foreign key (codigo_categoria) references categoria(codigo),
    foreign key (codigo_pessoa) references categoria(codigo)
);
